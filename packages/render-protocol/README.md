...
현재 `0.1.3`은 checksum-pinned GitHub Release와 GitHub Packages에 배포되는
...
```sh
npm install https://github.com/menaje/2d-cad-viewer/releases/download/viewer-core-v0.1.3/menaje-viewer-render-protocol-0.1.3.tgz
```
